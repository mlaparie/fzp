...
local function print_playlist_and_keybindings()
    ...
    local lines = get_playlist_lines("/tmp/audiobook-tui-playlist")
    ...
    local file_count_cmd = "wc -l < /tmp/audiobook-tui-playlist"
    ...
    -- Formatted message
    local playing_message = string.format("printf '\\033[34mPlaying %s (%s file(s)):\\033[0m\n\n'", current_and_parent_folder, file_count)
...
printf '\033[34mKeybindings:\033[0m
  ...
  \033[1;7m ←→/↑↓ \033[0;27m short/long seek                  \033[1;7m    F8 \033[0;27m show playlist
  \033[1;7m   </> \033[0;27m prev/next track                  \033[1;7m     q \033[0;27m stop playback and go back 
  \033[1;7m     _ \033[0;27m toggle interface type\033[0m
